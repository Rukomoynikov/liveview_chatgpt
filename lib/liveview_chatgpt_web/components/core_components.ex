defmodule LiveviewChatgptWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveviewChatgptWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveviewChatgptWeb.Gettext, "errors", msg, opts)
    end
  end
