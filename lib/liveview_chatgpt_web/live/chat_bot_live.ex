defmodule LiveviewChatgptWeb.ChatBotLive do
  use Phoenix.LiveView, container: {:div, [class: "fixed right-0 bottom-0 mr-4"]}

  alias Phoenix.LiveView.JS
  alias LiveviewChatgpt.Chatbot
  alias LiveviewChatgpt.ChatBot.Message

  def mount(_params, _session, socket) do
    conversation = Chatbot.list_conversations() |> Enum.at(0)

    {
      ...
      |> assign(:messages, Chatbot.list_conversation_messages(conversation))
    }
  end

  def handle_info({LiveviewChatgptWeb.Live.FormComponent, {:saved, message}}, socket) do
  ...
  def render(assigns) do
    ...
    <div class="flex flex-col flex-grow w-full max-w-xl bg-white shadow-xl rounded-t-lg overflow-hidden">
      ...
      <div class="bg-gray-300 p-4">
        <.live_component
          module={LiveviewChatgptWeb.Live.FormComponent}
          id="new_message"
